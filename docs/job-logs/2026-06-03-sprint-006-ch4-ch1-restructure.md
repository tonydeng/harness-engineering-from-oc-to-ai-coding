...
| docs/requirements/prd.md | 同步 | 更新 Ch4 + Ch1 状态 |
| docs/requirements/specs/ch04-workflows.md | 同步 | 更新 Prometheus 提取记录 |
| docs/requirements/specs/ch01-introduction.md | 同步 | 更新 failure-cases 注册 |
| docs/job-logs/2026-06-03-sprint-006-ch4-ch1-restructure.md | **新增** | 本日志 |
