...
```
docs/plans/book-outline.md          # 全书大纲
docs/plans/phase-1-scaffold.md      # 第1阶段：搭建框架
docs/plans/phase-2-content.md       # 第2阶段：内容编写
docs/plans/phase-3-polish.md        # 第3阶段：打磨发布
docs/requirements/user-stories.md   # 用户故事
docs/requirements/prd.md            # 产品需求文档
docs/requirements/specs/            # 详细规格目录（空）
```
