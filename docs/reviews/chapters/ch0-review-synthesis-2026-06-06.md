...
| oh-my-openagent 版本 | v4.7.x (v4.7.5) | v4.7.5 (Jun 3, 2026) | ✅ 正确 |
...
| PRD 版本号 (v1.15.x/v4.5.x) | — | 实际为 v1.16.x/v4.7.x | ⚠️ PRD 滞后（非 Ch0 问题） |
...
**优点**：README.md 的版本声明（v1.16.2 / v4.7.5 / v0.5.3）经过实时验证全部正确。这是"构建即理解"的好例子——声明具体版本号，读者可以自行验证。
...
PRD §3.5 声明 OpenCode v1.15.x / OMO v4.5.x，AGENTS.md 声明 mdBook v0.4.x，但实际版本为 v1.16.x / v4.7.x / v0.5.x。Ch0 文章的版本号是正确的。
...
| ID | 说明 |
|----|------|
| I-1 | PRD §3.5 版本号滞后（v1.15.x/v4.5.x vs 实际 v1.16.x/v4.7.x），非 Ch0 范围 |
