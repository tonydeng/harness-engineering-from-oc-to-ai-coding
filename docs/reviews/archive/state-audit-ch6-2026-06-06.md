# Chapter 6 State Audit — 2026-06-06

All 13 content articles in src/06-advanced/ are FULL content (0 stubs). Average ~368 non-blank lines each.

| File | Total Lines | Non-Blank | H1 Title |
|------|:-----------:|:---------:|----------|
| README.md | 39 | 30 | 第6章：高级话题 |
| custom-agents.md | 728 | 606 | 自定义 Agent 与 Plugin |
| mcp-servers.md | 642 | 508 | MCP 服务器 |
| security-overview.md | 567 | 442 | 安全总览 |
| sandbox-hooks.md | 561 | 454 | 沙箱与 Hook 系统 |
