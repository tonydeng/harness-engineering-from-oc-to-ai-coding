...
| `docs/reference/source-cross-references.md` | — | 引用更新 |
| `docs/planning/plans/implementation-plan.md` | — | 文件名更新 |
...
| 文件 | 变更 |
|------|------|
| `docs/planning/requirements/prd.md` | v2.5 保留为权威源 |
| `docs/planning/requirements/user-stories.md` | 映射表简化为速查引用 |
| `docs/logs/2026-06-05-sprint-007-content-consolidation.md` | **新增**（本日志） |
