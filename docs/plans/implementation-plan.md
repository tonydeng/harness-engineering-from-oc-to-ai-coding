...
|--------|-------|------------|---------|---------------|
| **01-核心概念速通** | ~1051 | 6核心概念(Agent/Skill/Command/Plugin/Team/MCP), OS类比, 安装指南, Provider配置, FAQ | Ch1(引言), Ch2(全部3篇现有 + 3篇新增), Ch5(Skill) | **Direct reuse** — 结构清晰，可直接适配 |
...
| R-2-4 | 修改 Ch2 Art.2.1: 增补马书Agent Loop | `src/02-core-concepts/agent-orchestration.md` | S | R-2-1 | 增补完整 |
