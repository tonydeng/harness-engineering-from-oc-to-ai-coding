...
- ← [§2.1 Agent 编排](../02-core-concepts/agent-orchestration.md)（Agent 系统基础）
- ← [§2.2 Skill 系统](../02-core-concepts/skills-system.md)（Plugin 概念初探）
- ← [§3.2 OpenCode 配置详解](../03-setup/opencode-config.md)（在配置中注册 Plugin）
- → [§7 案例研究](../07-case-studies/README.md)（自定义 Agent 在案例中的应用）
