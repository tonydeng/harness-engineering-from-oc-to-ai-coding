...
graph TB
    subgraph Ch0["读者导航"]
        C0_1["读者导航<br/>入门/技术负责人/需求分析师/UX/QA: P0"]
    end

    subgraph Ch1["简介"]
        C1_1["核心简介<br/>入门/技术负责人/工程经理/需求分析师/架构师: P0"]
        C1_2["生态对比<br/>技术负责人/工程经理/架构师: P0<br/>其他: P1"]
    end

    subgraph Ch2["核心概念"]
        C2_1["核心三要素<br/>入门/效率/技术负责人/Skill 作者: P0"]
        C2_2["进阶概念<br/>效率/Skill 作者/架构师/安全工程师: P0"]
    end

    subgraph Ch3["环境搭建"]
        C3_1["快速上手<br/>入门/效率/技术负责人/Skill 作者/后端/安全工程师: P0"]
        C3_2["高级配置<br/>效率/Skill 作者/架构师/后端: P1"]
    end

    subgraph Ch4["工作流实战"]
        C4_1["核心工作流<br/>入门/效率/技术负责人/架构师/后端/前端: P0"]
        C4_2["高级协作<br/>效率/技术负责人/架构师/后端/安全工程师/红队: P1"]
    end

    subgraph Ch5["Skill 开发"]
        C5_1["Skill 核心<br/>Skill 作者/前端: P0<br/>其他: P1"]
        C5_2["高级集成<br/>Skill 作者/后端/架构师: P1"]
    end

    subgraph Ch6["高级话题"]
        C6_1["MCP 服务器<br/>Skill 作者/后端/架构师/安全工程师/红队: P0"]
        C6_2["性能调优<br/>效率/工程经理: P0"]
        C6_3["安全章节<br/>技术负责人/架构师/安全工程师/红队: P0"]
    end

    subgraph Ch7["案例研究"]
        C7_1["核心案例<br/>效率/技术负责人/工程经理/后端: P0"]
