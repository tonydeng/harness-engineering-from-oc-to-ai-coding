...
**真实案例**：OpenCode issue [#18100](https://github.com/opencode-ai/opencode/issues/18100) 记录了一次真实事故——由于子 Agent 配置了 `tools: { task: true }`，一个任务在 73 分钟内递归派生出 **612 层嵌套会话**，几乎耗尽系统资源。
