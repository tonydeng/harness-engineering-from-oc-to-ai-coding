...
- ← [§2.3 工作流模式](../02-core-concepts/workflow-patterns.md) — Command 触发 Ultrawork
- ← [§3.3 oh-my-openagent 集成](../03-setup/oh-my-openagent-setup.md) — OMO 配置是 Ultrawork 的基础
- → [§4.2 多 Agent 协作](multi-agent-collab.md) — Ultrawork 与多 Agent 协作的关系
