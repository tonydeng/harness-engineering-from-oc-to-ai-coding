...
- ← [§3.1 快速上手](quickstart.md) — Provider 配置基础
- → [§6.3 性能调优与成本管理](../06-advanced/performance-tuning.md) — 国产模型在模型降级链中的应用
- ← [§1.5 国产 AI 编程生态适配](../01-introduction/chinese-ecosystem.md) — 生态现状与配置前提
