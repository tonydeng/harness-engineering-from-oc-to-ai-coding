...
> **桌面应用** (Beta): OpenCode 现提供桌面应用，支持 macOS、Windows、Linux。从 [opencode.ai/download](https://opencode.ai/download) 下载。
...
Harness Engineering 的第一条原则是**可控**。OpenCode 的权限系统让你精确控制 **Agent（智能体）** 能做什么、不能做什么。
