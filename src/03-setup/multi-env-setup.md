...
- ← [§3.2 OpenCode 配置详解](opencode-config.md) — Profile 配置基础
- → [§6.3 性能调优与成本管理](../06-advanced/performance-tuning.md) — 环境相关的成本管控配置
- → [§4 工作流实战](../04-workflows/README.md) — 不同环境使用不同的工作流模式
