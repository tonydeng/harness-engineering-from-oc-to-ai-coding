...
代码补全工具的本质是**增强型 IntelliSense**：它不会主动理解你的意图，只是在概率模型指导下猜测你可能要写的代码。开发者仍然是完全的主导者，AI 只是"打字加速器"。
...
timeline
    ...
    section 2.0 对话编程
        2024 : Cursor / Claude Code<br/>聊天交互模式
        2024 : Copilot Chat<br/>对话成为标配
        2025 : Agent 自主执行<br/>单 Agent 时代巅峰
    section 3.0 工程流水线
        2026 : OpenCode Agent 编排<br/>多 Agent 协同
        2026 : Skill 系统成熟<br/>知识可沉淀
        2026 : Workflow 工程化<br/>流水线可复现
```

**能力边界突破**：
- ✅ 多 Agent 专业分工（Plan/Build/Explore）
- ✅ Skill 系统封装领域知识
- ✅ Workflow 编排复杂流程
- ✅ 跨 Session 上下文持久化
- ✅ 质量门禁和审查机制
...
| 维度 | 1.0 代码补全 | 2.0 对话编程 | 3.0 工程流水线 |
|------|-------------|-------------|---------------|
| **代表工具** | GitHub Copilot、TabNine | Cursor、Claude Code | OpenCode |
| **交互模式** | 被动补全 | 多轮对话 | Agent 编排 |
| **AI 角色** | 打字加速器 | 对话伙伴 | 工程执行者 |
| **上下文范围** | 当前文件 | 当前会话 | 跨会话持久化 |
| **执行能力** | 无 | 单步操作 | 多步流水线 |
