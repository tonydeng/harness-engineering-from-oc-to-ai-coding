...
本文聚焦 **6 款核心工具**的深度对比——**OpenCode**、**Cursor**、**Claude Code**、**GitHub Copilot**、**Windsurf**、**OpenAI Codex CLI**——每款工具给出一句话定位、核心差异化特征和适用场景。同时提供 8 维量化对比矩阵和场景化选型指南。其余工具（Continue、Tabby、Aider、Goose 等）见文末扩展阅读。
...
1. **6 款核心工具定位** — OpenCode（开源 Agent 编排平台）、Cursor（编辑器内嵌 AI IDE）、Claude Code（终端 Agent 专家）、GitHub Copilot（生态渗透型代码补全）、Windsurf（AI 原生 IDE）、OpenAI Codex CLI（终端代码 Agent）。每款工具的核心理念、目标用户和典型使用场景。
...
3. **场景化选型决策树** — 个人开发者、小团队、企业级三个场景的推荐路径，将关键约束条件串联成清晰的判断。

4. **开源 vs 闭源的分水岭** — 开源工具的三大优势：可审计、可定制、无供应商锁定。闭源工具的两大优势：体验一致性、开箱即用。
...
- ← [**Harness Engineering（驾驭工程）** 理论框架](harness-engineering-theory.md)（5 大分类法指导对比维度的选择）
