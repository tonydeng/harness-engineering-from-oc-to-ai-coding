...
**定价模式**：核心引擎开源免费（BYOK，自带 API Key），Go 订阅 $10/月（提供托管模型和高级功能），Zen PAYG 按量计费。
...
**关键限制**：Provider 锁定（默认 Claude + OpenAI，无法接入国产模型）、闭源（代码不可审计）、订阅制（Pro $20/月、Pro+ $60/月、Ultra $200/月、Teams $40/用户/月）。
...
**关键限制**：Provider 锁定（仅支持 Claude 模型）、闭源、Pro $20/月（含 Claude Code 使用权）、Max $100–200/月、Team Premium $125/席位。
...
**关键限制**：Provider 锁定（仅 OpenAI 模型）、闭源、Pro $10/月、Pro+ $39/月、Max $100/月、Business $19/用户、Enterprise $39/用户）、隐私争议（代码用于训练）。
