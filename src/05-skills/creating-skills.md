...
- ← [§2.2 Skill 系统](../02-core-concepts/skills-system.md)（Skill 的理论基础和设计理念）
- → [§5.2 Skill 模板](skill-templates.md)（基于基础格式的模板复用）
- → [§5.3 Skill 最佳实践](skill-best-practices.md)（从实践经验中提炼的设计原则）
