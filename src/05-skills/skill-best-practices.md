...
---
# 正文
使用 claude-3-opus-20240229 模型生成代码...
```
...
description: 数据处理专家
---
# Skill 可以访问所有工具，包括 Bash、Delete 等高风险工具
```
...
安全审计 Agent 的 Skill 通常具有高风险权限（如 Bash）。如果这些 Skill 对其他 Agent 可见，可能导致权限提升攻击。
