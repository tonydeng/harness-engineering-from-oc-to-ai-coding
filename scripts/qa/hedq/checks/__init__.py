...
- 自动化检测实际覆盖的子项满分：D1.1+D1.2+D1.4=11, D2.2=6, D3.1=6, D4.1=4,
  D5.1+D5.2+D5.3=10, D6.3=2, D7.1+D7.2+D7.3=10, D8.1+D8.2=3.5 = 52.5 分
- 未自动化覆盖的子项（D1.3/D2.1/D2.3/D3.2/D3.3/D4.2/D4.3/D6.1/D6.2/D6.4/D8.3）
  共 47.5 分需人工审核。
